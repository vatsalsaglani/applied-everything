---
title: "Find the Maximum amount of water which can be stored in a container"
summary: "Given an array or heights we need to find two height between which the maximum water can be stored"
publishedAt: "2021-05-03"
tags: "python3, programming, arrays, lists, maxArea, leetcode"
---
