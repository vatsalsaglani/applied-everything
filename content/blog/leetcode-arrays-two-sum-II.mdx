...
summary: "The Two sum II problem is the extension of the Two Sum problem which can be solved using the pointers technique"
tags: "python3, program, arrays, lists, pointers, algorithms, data structures, two sum II"
cover_image: "https://i.imgur.com/oyrfJjH.png"
---

As seen in the question <a target="_blank" href="/blog/leetcode-arrays-two-sum">Two Sum in Python using dictionary</a> given a list of `integers` and a `target` integer the algorithm needs to return the indices of two numbers which can be added to get the target. 
...
The bruteforce solution will be same as the one in the <a target="_blank" href="/blog/leetcode-arrays-two-sum">previous blog</a>.


### Solution and Explanation


```dart:towsumtwo_onepass.py
